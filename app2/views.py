    ...
    if request.session.has_key("email"):
        ...
        if ut == "admin":
            if request.method=="POST":
                ...
                lgn.email = em
                lgn.password = paswrd
                lgn.usertype = "accountant"

                adm.save()
                lgn.save()
                return render(request,"AccountantReg.html",{"msg":"Data Saved"})
            else:
        ...
        if ut != "student":
            if request.method=="POST":
                ...
                if ut=="admin":
                    ...
                    return render(request, "StudentReg1.html", {"msg": "Data Saved"})
            else:
                if ut == "admin":
                    return render(request, "StudentReg.html" )
                elif ut == "accountant":
                    return render(request, "StudentReg1.html")
        else:
            return HttpResponseRedirect("/autherror/")
    else:
        return HttpResponseRedirect("/autherror/")
...
def accountant_home(request):
    if request.session.has_key("email"):
        ...
        em = request.session["email"]
        if ut == "accountant":
            acnt = Accountantdata.objects.filter(email=em)
            pic = Photodata.objects.filter(email=em)
            return render(request,"AccountantHome.html",{"data":acnt,"data1":pic})
        else:
            return HttpResponseRedirect("/autherror/")
    else:
        return HttpResponseRedirect("/autherror/")

def editacntprofile(request):
    if request.session.has_key("email"):
        ut = request.session["ut"]
        em = request.session["email"]
        if ut == "accountant":
            if request.method == "POST":
                acnt = Accountantdata.objects.filter(email=em)
                return render(request, "EditAccountant.html", {"data": acnt})
            else:
                return HttpResponseRedirect("/autherror/")
        else:
            return HttpResponseRedirect("/autherror/")
    ...
    if request.session.has_key("email"):
        ...
        if ut == "accountant":
            if request.method == "POST":
                ...
                data.save()
                return render(request, "EditAccountant.html", {"msg": "Profile Updated Successfully"})
            else:
                return HttpResponseRedirect("/accountant_home/")
        else:
            return HttpResponseRedirect("/autherror/")
...
def accountant_pass_change(request):
    if request.session.has_key("email"):
        ut = request.session["ut"]
        if ut == "accountant":
            if request.method == "POST":
                em = request.POST["E1"]
                data = Accountantdata.objects.filter(email=em)
                return render(request, "AccountantPassChange.html", {"data":data})
            else:
                return HttpResponseRedirect("/accountant_home/")
        else:
            return HttpResponseRedirect("/autherror/")
...
def accountant_pass_change1(request):
    if request.session.has_key("email"):
        ut = request.session["ut"]
        em = request.session["email"]
        if ut == "accountant":
            if request.method == "POST":
                ...
                ACC.password = new
                ACC.save()
                return render(request, "AccountantPassChange.html", {"msg":"PASSWORD CHANGED"})
            else:
                return HttpResponseRedirect("/accountant_home/")
        else:
            return HttpResponseRedirect("/autherror/")
        ...
        if ut == "student":
            if request.method == "POST":
                ...
                if ut == "admin":
                    ...
                    return render(request, "EditStudentac.html", {"data": std})
                elif ut == "student":
        ...
        if ut == "student":
            if request.method == "POST":
                ...
                if ut == "admin":
                    ...
                    return render(request, "EditStudentac.html", {"msg": "details edited Successfully"})
                elif ut == "student":
...
def allaccountants(request):
    if request.session.has_key("email"):
        ut = request.session["ut"]
        if ut == "admin":
            records = Accountantdata.objects.all()
            return render(request, 'AllAccountants.html', {"data": records})
        else:
            return HttpResponseRedirect("/autherror/")
    else:
        return HttpResponseRedirect("/autherror/")

def edit_ac_data(request):
    if request.session.has_key("email"):
        ut = request.session["ut"]
        if ut == "admin":
            if request.method == "POST":
                em = request.POST["E1"]
                acc = Accountantdata.objects.filter(email=em)
                return render(request, 'EditAcData.html', {"data": acc})
            else:
                return HttpResponseRedirect("/allaccountants/")
        else:
            return HttpResponseRedirect("/autherror/")
    else:
        return HttpResponseRedirect("/autherror/")

def edit_ac_data1(request):
    if request.session.has_key("email"):
        ut = request.session["ut"]
        if ut == "admin":
            if request.method == "POST":
                ...
                mob = request.POST["t3"]
                em = request.POST["t4"]
                acc = Accountantdata.objects.get(email=em)
                ...
                acc.save()
                return render(request, 'EditAcData.html', {"msg": "DATA EDITED SUCCESSFULLY"})
            else:
                return HttpResponseRedirect("/allaccountants/")
        else:
            return HttpResponseRedirect("/autherror/")
    ...
    if request.session.has_key("email"):
        ...
        if ut == "admin":
            if request.method == "POST":
                em = request.POST["E1"]
                acc = Accountantdata.objects.filter(email=em)
                return render(request, 'DeleteAcData.html', {"data": acc})
            else:
                return HttpResponseRedirect("/allaccountants/")
        else:
            return HttpResponseRedirect("/autherror/")
    ...
    if request.session.has_key("email"):
        ...
        if ut == "admin":
            if request.method == "POST":
                em = request.POST["E1"]
                acc = Accountantdata.objects.get(email=em)
                lgn = Logindata.objects.get(email=em)
                acc.delete()
                lgn.delete()
                return render(request, 'DeleteAcData.html', {"msg": "Accountant Data Deleted Successfully"})
            else:
                return HttpResponseRedirect("/allaccountants/")
        else:
            return HttpResponseRedirect("/autherror/")
    ...
    if request.session.has_key("email"):
        ...
        if request.method == "POST":
            ...
            if ut=="admin":
                ...
                return render(request, "UploadPhotoacc.html")
    else:
        return HttpResponseRedirect("/autherror/")
    ...
    if request.session.has_key("email"):
        ...
        if request.method == "POST":
            ...
            if ut=="admin":
                ...
                return render(request, "ChangePhotoacc.html", {"data": dlt})
        else:
            return HttpResponseRedirect("/admin_home/")
    else:
        return HttpResponseRedirect("/autherror/")
    ...
    if request.session.has_key("email"):
        ...
        if request.method == "POST":
            ...
            if ut=="admin":
                ...
                return render(request, "ChangePhotoacc.html")
    else:
        return HttpResponseRedirect("/autherror/")
    ...
    if request.session.has_key("email"):
        ...
        if request.method == "POST":
            ...
            if ut=="admin":
                ...
                return render(request, "DeletePhotoacc.html", {"data": dlt})
        else:
            return HttpResponseRedirect("/admin_home/")
    else:
        return HttpResponseRedirect("/autherror/")
...
#  for student by Accountant
def allstudentsACC(request):
    if request.session.has_key("email"):
        ut = request.session["ut"]
        if ut=="accountant":
            stdata = Studentdata.objects.all()
            return render(request,"AllStudentsACC.html",{"data":stdata})
        elif ut=="admin":
            stdata = Studentdata.objects.all()
    ...
    if request.session.has_key("email"):
        ...
        if ut=="accountant":
            if request.method == "POST":
                ...
                list.append(crinst)
                list.append(due)
                return render(request,"viewstudentACC.html",{"data1":stprofile,"data2":stcrse,"data3":stinstall,"data4":pic,"data5":list})
            else:
                return HttpResponseRedirect("/accountant_home/")
        else:
            return HttpResponseRedirect("/autherror/")
...
def studentcourseadd_acc(request):
    if request.session.has_key("email"):
        ut = request.session["ut"]
        if ut == "accountant":
            if request.method=="POST":
                ...
                sid = request.POST["A1"]
                list.append(sid)
                return render(request,"StudentCourseregACC.html",{"data":obj,"data1":list})
            else:
...
def studentcourseadd_acc1(request):
    if request.session.has_key("email"):
        ut = request.session["ut"]
        if ut == "accountant":
            if request.method=="POST":
                ...
                return render(request,"StudentCourseregACC.html",{"msg":"Course Added in Student Profile"})
            else:
                return HttpResponseRedirect("/allstudentsACC/")
        else:
            return HttpResponseRedirect("/autherror/")
...
def studentinstallmentadd_acc(request):
    if request.session.has_key("email"):
        ut = request.session["ut"]
        if ut == "accountant":
            if request.method=="POST":
                ...
                return render(request,"AddInstallmentACC.html",{"data":obj})
            else:
                return HttpResponseRedirect("/allstudentsACC/")
        else:
            return HttpResponseRedirect("/autherror/")
...
def studentinstallmentadd_acc1(request):
    if request.session.has_key("email"):
        ut = request.session["ut"]
        if ut == "accountant":
            if request.method=="POST":
                ...
                return render(request,"AddInstallmentACC.html",{"msg":"Installment Added"})
        ...
        if ut != "student":
            if request.method=="POST":
                ...
                if ut == "admin":
                    ...
                    return render(request, "EditStData.html", {"data": stdata})
            else:
                if ut == "admin":
                    return HttpResponseRedirect("/ADviewstudent/")
                else:
        ...
        if ut != "student":
            if request.method=="POST":
                ...
                if ut == "admin":
                    ...
                    return render(request, "EditStData.html", {"msg":"Student Data Updated Successfully"})
            else:
                if ut == "admin":
                    return HttpResponseRedirect("/ADviewstudent/")
                else:
